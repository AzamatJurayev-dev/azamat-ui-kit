...
@layer components {
  ...
  [data-slot="badge"][data-variant="default"] {
    ...
    color: color-mix(in oklch, var(--primary), black 36%);
  }
  ...
  [data-slot="badge"][data-tone="info"] {
    border-color: color-mix(in oklch, var(--aui-info), transparent 72%);
    background: color-mix(in oklch, var(--aui-info), transparent 84%);
    color: color-mix(in oklch, var(--aui-info), black 18%);
  }

  [data-slot="badge"][data-tone="success"] {
    border-color: color-mix(in oklch, var(--aui-success), transparent 72%);
    background: color-mix(in oklch, var(--aui-success), transparent 84%);
    color: color-mix(in oklch, var(--aui-success), black 18%);
  }

  [data-slot="badge"][data-tone="warning"] {
    border-color: color-mix(in oklch, var(--aui-warning), transparent 66%);
  ...
  [data-slot="select-content"][data-slot="select-content"] {
    border-color: color-mix(in oklch, var(--border), white 8%);
    background: color-mix(in oklch, var(--popover), transparent 6%);
