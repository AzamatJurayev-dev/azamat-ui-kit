...
const generatedSourceRegistry: ComponentRegistryItem[] = [
  ...
  { name: "stat-card", category: "layout", migrationAliasFor: "card" },
  { name: "smart-card", category: "display", migrationAliasFor: "card" },
  { name: "trend-card", category: "display", migrationAliasFor: "card" },
  ...
  { name: "kpi", category: "charts", migrationAliasFor: "chart-card" },
  ...
  { name: "map", category: "modern", dependencies: ["lucide-react"], registryDependencies: ["badge", "button", "utils"], files: [file("src/components/modern/map.tsx", "{components}/modern/map.tsx")] },
  { name: "media-player", category: "modern", dependencies: ["lucide-react"], registryDependencies: ["badge", "button", "utils"], files: [file("src/components/modern/media-player.tsx", "{components}/modern/media-player.tsx")] },
  { name: "spreadsheet", category: "modern", dependencies: ["lucide-react"], registryDependencies: ["button", "utils"], files: [file("src/components/modern/spreadsheet.tsx", "{components}/modern/spreadsheet.tsx")] },
