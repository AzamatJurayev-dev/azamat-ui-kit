...
export const registry: Record<ComponentName, ComponentRegistryItem> = {
  ...
  "app-input": { name: "app-input", category: "inputs", migrationAliasFor: "input", registryDependencies: ["input-decorator", "clearable-input", "search-input", "password-input", "number-input", "phone-input", "date-input"], files: [file("src/components/inputs/app-input.tsx", "{components}/inputs/app-input.tsx")] },
  ...
  "form-app-input": { name: "form-app-input", category: "form", migrationAliasFor: "form-input", dependencies: ["react-hook-form"], registryDependencies: ["app-input", "form-field-shell", "form-field-utils"], files: [file("src/components/form/form-app-input.tsx", "{components}/form/form-app-input.tsx")] },
  ...
  "form-search-input": { name: "form-search-input", category: "form", migrationAliasFor: "form-input", dependencies: ["react-hook-form"], registryDependencies: ["form-app-input"], files: [file("src/components/form/form-search-input.tsx", "{components}/form/form-search-input.tsx")] },
  ...
  "form-number-input": { name: "form-number-input", category: "form", migrationAliasFor: "form-input", dependencies: ["react-hook-form"], registryDependencies: ["form-app-input"], files: [file("src/components/form/form-number-input.tsx", "{components}/form/form-number-input.tsx")] },
  "form-phone-input": { name: "form-phone-input", category: "form", migrationAliasFor: "form-input", dependencies: ["react-hook-form"], registryDependencies: ["form-app-input"], files: [file("src/components/form/form-phone-input.tsx", "{components}/form/form-phone-input.tsx")] },
  "form-date-input": { name: "form-date-input", category: "form", migrationAliasFor: "form-input", dependencies: ["react-hook-form"], registryDependencies: ["form-app-input"], files: [file("src/components/form/form-date-input.tsx", "{components}/form/form-date-input.tsx")] },
...
const generatedSourceRegistry: ComponentRegistryItem[] = [
  { name: "action-bar", category: "actions", files: [file("src/components/actions/action-bar.tsx", "{components}/actions/action-bar.tsx")] },
  { name: "action-menu", category: "actions", files: [file("src/components/actions/action-menu.tsx", "{components}/actions/action-menu.tsx")] },
  { name: "action-system", category: "patterns", files: [file("src/components/patterns/action-system.tsx", "{components}/patterns/action-system.tsx")] },
  ...
  { name: "app-shell", category: "layout", files: [file("src/components/layout/app-shell.tsx", "{components}/layout/app-shell.tsx")] },
  ...
  { name: "crud-system", category: "patterns", files: [file("src/components/patterns/crud-system.tsx", "{components}/patterns/crud-system.tsx")] },
  ...
  { name: "data-view", category: "patterns", files: [file("src/components/patterns/data-view.tsx", "{components}/patterns/data-view.tsx")] },
  ...
  { name: "entity-details", category: "patterns", files: [file("src/components/patterns/entity-details.tsx", "{components}/patterns/entity-details.tsx")] },
  ...
  { name: "filter-builder", category: "patterns", files: [file("src/components/patterns/filter-builder.tsx", "{components}/patterns/filter-builder.tsx")] },
  ...
  { name: "resource-system", category: "patterns", files: [file("src/components/patterns/resource-system.tsx", "{components}/patterns/resource-system.tsx")] },
  ...
  { name: "status-system", category: "patterns", files: [file("src/components/patterns/status-system.tsx", "{components}/patterns/status-system.tsx")] },
  ...
  { name: "workspace-shell", category: "layout", files: [file("src/components/layout/workspace-shell.tsx", "{components}/layout/workspace-shell.tsx")] },
  { name: "card-family", category: "families", files: [file("src/families/card-family.ts", "src/families/card-family.ts")] },
  { name: "component-family-catalog", category: "families", files: [file("src/families/catalog.ts", "src/families/catalog.ts")] },
  { name: "data-table-family", category: "families", files: [file("src/families/data-table-family.ts", "src/families/data-table-family.ts")] },
  { name: "docs-adoption", category: "families", files: [file("src/families/docs-adoption.ts", "src/families/docs-adoption.ts")] },
  { name: "docs-groups", category: "families", files: [file("src/families/docs-groups.ts", "src/families/docs-groups.ts")] },
  { name: "docs-queries", category: "families", files: [file("src/families/docs-queries.ts", "src/families/docs-queries.ts")] },
  { name: "docs-routing", category: "families", files: [file("src/families/docs-routing.ts", "src/families/docs-routing.ts")] },
  { name: "form-family", category: "families", files: [file("src/families/form-family.ts", "src/families/form-family.ts")] },
  { name: "input-family", category: "families", files: [file("src/families/input-family.ts", "src/families/input-family.ts")] },
  { name: "member-metadata", category: "families", files: [file("src/families/member-metadata.ts", "src/families/member-metadata.ts")] },
  { name: "member-queries", category: "families", files: [file("src/families/member-queries.ts", "src/families/member-queries.ts")] },
  { name: "member-snippets", category: "families", files: [file("src/families/member-snippets.ts", "src/families/member-snippets.ts")] },
  { name: "member-snippet-queries", category: "families", files: [file("src/families/member-snippet-queries.ts", "src/families/member-snippet-queries.ts")] },
  { name: "migration-map", category: "families", files: [file("src/families/migration-map.ts", "src/families/migration-map.ts")] },
  { name: "family-queries", category: "families", files: [file("src/families/queries.ts", "src/families/queries.ts")] },
  { name: "select-family", category: "families", files: [file("src/families/select-family.ts", "src/families/select-family.ts")] },
  { name: "family-views", category: "families", files: [file("src/families/views.ts", "src/families/views.ts")] },
  { name: "families", category: "families", files: [file("src/families/index.ts", "src/families/index.ts")] },
];
