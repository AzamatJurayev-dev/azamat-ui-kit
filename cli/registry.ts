...
export const registry: Record<ComponentName, ComponentRegistryItem> = {
  ...
  input: { name: "input", category: "ui", dependencies: ["@base-ui/react", "class-variance-authority", "lucide-react"], registryDependencies: ["button", "utils"], files: [file("src/components/ui/input", "{ui}/input"), file("src/components/ui/input.tsx", "{ui}/input.tsx")] },
  ...
  "input-decorator": { name: "input-decorator", category: "inputs", migrationAliasFor: "input", dependencies: ["class-variance-authority"], registryDependencies: ["input", "utils"], files: [file("src/components/inputs/input-decorator.tsx", "{components}/inputs/input-decorator.tsx")] },
  ...
  "clearable-input": { name: "clearable-input", category: "inputs", migrationAliasFor: "input", dependencies: ["lucide-react"], registryDependencies: ["input-decorator", "input-value"], files: [file("src/components/inputs/clearable-input.tsx", "{components}/inputs/clearable-input.tsx")] },
  "search-input": { name: "search-input", category: "inputs", migrationAliasFor: "input", dependencies: ["lucide-react"], registryDependencies: ["clearable-input"], files: [file("src/components/inputs/search-input.tsx", "{components}/inputs/search-input.tsx")] },
  "password-input": { name: "password-input", category: "inputs", migrationAliasFor: "input", dependencies: ["lucide-react"], registryDependencies: ["input-decorator"], files: [file("src/components/inputs/password-input.tsx", "{components}/inputs/password-input.tsx")] },
  "number-input": { name: "number-input", category: "inputs", migrationAliasFor: "input", registryDependencies: ["input-decorator"], files: [file("src/components/inputs/number-input.tsx", "{components}/inputs/number-input.tsx")] },
  "date-input": { name: "date-input", category: "inputs", migrationAliasFor: "input", dependencies: ["lucide-react"], registryDependencies: ["input-decorator", "input-value"], files: [file("src/components/inputs/date-input.tsx", "{components}/inputs/date-input.tsx")] },
  "date-range-input": { name: "date-range-input", category: "inputs", migrationAliasFor: "input", registryDependencies: ["date-input", "utils"], files: [file("src/components/inputs/date-range-input.tsx", "{components}/inputs/date-range-input.tsx")] },
  "money-input": { name: "money-input", category: "inputs", migrationAliasFor: "input", registryDependencies: ["input", "utils"], files: [file("src/components/inputs/money-input.tsx", "{components}/inputs/money-input.tsx")] },
  "quantity-input": { name: "quantity-input", category: "inputs", migrationAliasFor: "input", dependencies: ["lucide-react"], registryDependencies: ["button", "input", "utils"], files: [file("src/components/inputs/quantity-input.tsx", "{components}/inputs/quantity-input.tsx")] },
  "masked-input": { name: "masked-input", category: "inputs", migrationAliasFor: "input", registryDependencies: ["input-decorator", "input-value"], files: [file("src/components/inputs/masked-input.tsx", "{components}/inputs/masked-input.tsx")] },
  "phone-input": { name: "phone-input", category: "inputs", migrationAliasFor: "input", dependencies: ["lucide-react"], registryDependencies: ["masked-input"], files: [file("src/components/inputs/phone-input.tsx", "{components}/inputs/phone-input.tsx")] },
  ...
  "simple-select": { name: "simple-select", category: "inputs", migrationAliasFor: "select", dependencies: ["lucide-react"], registryDependencies: ["select", "utils"], files: [file("src/components/inputs/simple-select.tsx", "{components}/inputs/simple-select.tsx")] },
  ...
  inputs: { name: "inputs", category: "group", migrationAliasFor: "input", registryDependencies: ["input", "tag-input", "async-select"], files: [file("src/components/inputs/index.ts", "{components}/inputs/index.ts")] },

  "form-field-shell": { name: "form-field-shell", category: "form", migrationAliasFor: "input", registryDependencies: ["utils"], files: [file("src/components/form/form-field-shell.tsx", "{components}/form/form-field-shell.tsx")] },
  "form-input": { name: "form-input", category: "form", migrationAliasFor: "input", dependencies: ["react-hook-form"], registryDependencies: ["input", "form-field-shell"], files: [file("src/components/form/form-input.tsx", "{components}/form/form-input.tsx")] },
  "form-select": { name: "form-select", category: "form", migrationAliasFor: "select", dependencies: ["react-hook-form"], registryDependencies: ["select", "async-select", "form-field-shell"], files: [file("src/components/form/form-select.tsx", "{components}/form/form-select.tsx")] },
  "form-async-select": { name: "form-async-select", category: "form", migrationAliasFor: "select", dependencies: ["react-hook-form"], registryDependencies: ["async-select", "form-field-shell"], files: [file("src/components/form/form-async-select.tsx", "{components}/form/form-async-select.tsx")] },
  "form-textarea": { name: "form-textarea", category: "form", migrationAliasFor: "textarea", dependencies: ["react-hook-form"], registryDependencies: ["textarea", "form-field-shell"], files: [file("src/components/form/form-textarea.tsx", "{components}/form/form-textarea.tsx")] },
  "form-switch": { name: "form-switch", category: "form", migrationAliasFor: "switch", dependencies: ["react-hook-form"], registryDependencies: ["switch", "form-field-shell", "utils"], files: [file("src/components/form/form-switch.tsx", "{components}/form/form-switch.tsx")] },
  ...
  "stat-card": { name: "stat-card", category: "layout", migrationAliasFor: "metric-grid", registryDependencies: ["card", "badge", "utils"], files: [file("src/components/layout/stat-card.tsx", "{components}/layout/stat-card.tsx")] },
...
const generatedSourceRegistry: ComponentRegistryItem[] = [
  ...
  { name: "app-header", category: "layout", migrationAliasFor: "sidebar", files: [file("src/components/layout/app-header.tsx", "{components}/layout/app-header.tsx")] },
  ...
  { name: "combobox", category: "inputs", migrationAliasFor: "select", files: [file("src/components/inputs/combobox.tsx", "{components}/inputs/combobox.tsx")] },
  ...
  { name: "data-table-actions-column", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/data-table-actions-column.tsx", "{components}/data-table/data-table-actions-column.tsx")] },
  { name: "data-table-bulk-actions", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/data-table-bulk-actions.tsx", "{components}/data-table/data-table-bulk-actions.tsx")] },
  { name: "data-table-column-visibility-menu", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/data-table-column-visibility-menu.tsx", "{components}/data-table/data-table-column-visibility-menu.tsx")] },
  { name: "data-table-pagination", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/data-table-pagination.tsx", "{components}/data-table/data-table-pagination.tsx")] },
  { name: "data-table-row-actions", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/data-table-row-actions.tsx", "{components}/data-table/data-table-row-actions.tsx")] },
  { name: "data-table-select-column", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/data-table-select-column.tsx", "{components}/data-table/data-table-select-column.tsx")] },
  { name: "data-table-sortable-header", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/data-table-sortable-header.tsx", "{components}/data-table/data-table-sortable-header.tsx")] },
  { name: "data-table-toolbar", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/data-table-toolbar.tsx", "{components}/data-table/data-table-toolbar.tsx")] },
  { name: "data-table-view-presets", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/data-table-view-presets.tsx", "{components}/data-table/data-table-view-presets.tsx")] },
  { name: "data-table-saved-filters", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/data-table-saved-filters.tsx", "{components}/data-table/data-table-saved-filters.tsx")] },
  ...
  { name: "file-dropzone", category: "upload", migrationAliasFor: "file-upload", files: [file("src/components/upload/file-dropzone.tsx", "{components}/upload/file-dropzone.tsx")] },
  ...
  { name: "page-container", category: "layout", migrationAliasFor: "sidebar", files: [file("src/components/layout/page-container.tsx", "{components}/layout/page-container.tsx")] },
  ...
  { name: "section-header", category: "layout", migrationAliasFor: "section", files: [file("src/components/layout/section-header.tsx", "{components}/layout/section-header.tsx")] },
  { name: "sidebar-nav", category: "layout", migrationAliasFor: "sidebar", files: [file("src/components/layout/sidebar-nav.tsx", "{components}/layout/sidebar-nav.tsx")] },
  ...
  { name: "sticky-footer-bar", category: "layout", migrationAliasFor: "sidebar", files: [file("src/components/layout/sticky-footer-bar.tsx", "{components}/layout/sticky-footer-bar.tsx")] },
  { name: "table-export-menu", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/table-export-menu.tsx", "{components}/data-table/table-export-menu.tsx")] },
  { name: "table-import-button", category: "data-table", migrationAliasFor: "data-table", files: [file("src/components/data-table/table-import-button.tsx", "{components}/data-table/table-import-button.tsx")] },
