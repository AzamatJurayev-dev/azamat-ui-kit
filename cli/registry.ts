...
export const registry: Record<ComponentName, ComponentRegistryItem> = {
  ...
  "loading-state": { name: "loading-state", category: "feedback", registryDependencies: ["state-view"], files: [file("src/components/feedback/loading-state.tsx", "{components}/feedback/loading-state.tsx")] },
  "page-state": { name: "page-state", category: "feedback", registryDependencies: ["state-view", "utils"], files: [file("src/components/feedback/page-state.tsx", "{components}/feedback/page-state.tsx")] },
