...
export const registry: Record<ComponentName, ComponentRegistryItem> = {
  ...
  layout: { name: "layout", category: "group", registryDependencies: ["sidebar", "breadcrumbs", "section"], files: [file("src/components/layout/index.ts", "{components}/layout/index.ts")] },
...
const generatedSourceRegistry: ComponentRegistryItem[] = [
  ...
  { name: "app-header", category: "layout", migrationAliasFor: "sidebar" },
  ...
  { name: "tag", category: "display", registryDependencies: ["utils"], files: [file("src/components/display/tag.tsx", "{components}/display/tag.tsx")] },
  ...
  { name: "page-header", category: "layout", migrationAliasFor: "section" },
  { name: "page-container", category: "layout", migrationAliasFor: "sidebar" },
  { name: "section-header", category: "layout", migrationAliasFor: "section" },
  { name: "sidebar-nav", category: "layout", migrationAliasFor: "sidebar" },
  { name: "stat-card", category: "layout", migrationAliasFor: "statistic" },
  { name: "sticky-footer-bar", category: "layout", migrationAliasFor: "sidebar" },
  ...
  { name: "result", category: "display", migrationAliasFor: "page-state" },
  ...
  { name: "bulk-action-bar", category: "patterns", registryDependencies: ["button", "utils"], files: [file("src/components/patterns/bulk-action-bar.tsx", "{components}/patterns/bulk-action-bar.tsx")] },
  { name: "data-view", category: "patterns", registryDependencies: ["data-table", "empty-state", "page-toolbar", "utils"], files: [file("src/components/patterns/data-view.tsx", "{components}/patterns/data-view.tsx")] },
  ...
  { name: "progress-ring", category: "charts", migrationAliasFor: "progress-circle" },
  { name: "progress-circle", category: "charts", files: [file("src/components/charts/progress-circle.tsx", "{components}/charts/progress-circle.tsx"), file("src/components/charts/progress-ring.tsx", "{components}/charts/progress-ring.tsx")] },
  ...
  { name: "page-toolbar", category: "patterns", registryDependencies: ["utils"], files: [file("src/components/patterns/page-toolbar.tsx", "{components}/patterns/page-toolbar.tsx")] },
  { name: "settings-page", category: "patterns", registryDependencies: ["tabs", "utils"], files: [file("src/components/patterns/settings-page.tsx", "{components}/patterns/settings-page.tsx")] },
  ...
  { name: "rich-text-editor", category: "modern", dependencies: ["@tiptap/react", "@tiptap/pm", "@tiptap/starter-kit", "@tiptap/extension-link", "@tiptap/extension-placeholder", "lucide-react"], registryDependencies: ["utils"], files: [file("src/components/modern/rich-text-editor.tsx", "{components}/modern/rich-text-editor.tsx")] },
