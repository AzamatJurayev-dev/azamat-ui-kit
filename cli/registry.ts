...
export const registry: Record<ComponentName, ComponentRegistryItem> = {
  ...
  "form-app-input": { name: "form-app-input", category: "form", migrationAliasFor: "form-input", dependencies: ["react-hook-form"], registryDependencies: ["app-input", "form-field-shell"], files: [file("src/components/form/form-app-input.tsx", "{components}/form/form-app-input.tsx")] },
