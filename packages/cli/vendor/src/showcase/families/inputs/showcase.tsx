    ...
    <div className="grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
      <div className="space-y-4">
        <div className="rounded-[22px] border border-[color:var(--aui-surface-border)] bg-[color:var(--aui-surface)] p-4">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
            <div className="space-y-3">
              ...
              <div>
                <p className="aui-text-strong text-sm font-medium">Async entity search flow</p>
                <p className="aui-text-muted mt-1 text-sm leading-6">
                  Remote loading, hydration, create option, grouped results, multiselect, and limit handling should all stay visible in this route.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap gap-2">
          ...
          <div className="mt-4 grid gap-4 xl:grid-cols-2">
            <div className="rounded-[20px] border border-[color:var(--aui-surface-border)] bg-[color:var(--aui-surface)] p-4">
              <p className="aui-text-strong text-sm font-medium">Single select</p>
              <p className="aui-text-muted mt-1 text-sm leading-6">Hydrate selected value, search grouped results and allow create flow.</p>
              <div className="mt-4">
            ...
            <div className="rounded-[20px] border border-[color:var(--aui-surface-border)] bg-[color:var(--aui-surface)] p-4">
              <p className="aui-text-strong text-sm font-medium">Multi select</p>
              <p className="aui-text-muted mt-1 text-sm leading-6">Select all visible options, cap selection count and keep tags removable.</p>
              <div className="mt-4">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="rounded-[20px] border border-[color:var(--aui-surface-border)] bg-[color:var(--aui-page-bg-alt)] px-4 py-3">
            ...
            <p className="aui-text-strong mt-2 text-sm font-medium">{activeSingle?.label ?? "Nothing selected"}</p>
          </div>
          <div className="rounded-[20px] border border-[color:var(--aui-surface-border)] bg-[color:var(--aui-page-bg-alt)] px-4 py-3">
            <p className="aui-text-muted text-sm">Linked modules</p>
            <p className="aui-text-strong mt-2 text-sm font-medium">{activeMultiCount} attached</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4 rounded-[22px] border border-[color:var(--aui-surface-border)] bg-[color:var(--aui-surface)] p-4">
        ...
        <div className="grid gap-3">
          ...
          <div className="rounded-[20px] border border-[color:var(--aui-surface-border)] bg-[color:var(--aui-surface)] p-4">
            <p className="aui-text-muted text-sm">Single selection</p>
            <p className="aui-text-strong mt-2 text-lg font-semibold">{activeSingle?.data.team ?? "No team"}</p>
            <p className="aui-text-strong mt-2 text-sm">{activeSingle?.description ?? "Choose a workspace to hydrate its shell."}</p>
          </div>
          <div className="rounded-[20px] border border-[color:var(--aui-surface-border)] bg-[color:var(--aui-surface)] p-4">
            <p className="aui-text-muted text-sm">Use cases</p>
            <div className="aui-text-strong mt-3 space-y-2 text-sm">
