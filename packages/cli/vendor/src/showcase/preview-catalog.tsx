...
export const previewSurfaceCatalog: PreviewSurfaceRecord[] = [
  {
    ...
    command: "npx @azamatjurayevdev/azix-ui init --template next --defaults\nnpx @azamatjurayevdev/azix-ui add app-sidebar metric-grid data-table",
  ...
  },
  {
    ...
    command: "npx @azamatjurayevdev/azix-ui add data-table",
  ...
  },
  {
    ...
    command: "npx @azamatjurayevdev/azix-ui add input button",
  ...
  },
  {
    ...
    command: "npx @azamatjurayevdev/azix-ui add badge button",
  ...
  },
  {
    ...
    command: "npx @azamatjurayevdev/azix-ui add command-palette",
  ...
  },
  {
    ...
    command: "npx @azamatjurayevdev/azix-ui add calendar date-picker",
  ...
  },
  {
    ...
    command: "npx @azamatjurayevdev/azix-ui add file-upload image-upload",
