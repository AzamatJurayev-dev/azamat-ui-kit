...
export const previewSurfaceCatalog: PreviewSurfaceRecord[] = [
  {
    ...
    command: "npx azamat-ui-kit-cli init --template next --defaults\nnpx azamat-ui-kit-cli add app-sidebar metric-grid data-table",
  ...
  },
  {
    ...
    command: "npx azamat-ui-kit-cli add data-table",
  ...
  },
  {
    ...
    command: "npx azamat-ui-kit-cli add command-palette",
  ...
  },
  {
    ...
    command: "npx azamat-ui-kit-cli add calendar date-picker",
  ...
  },
  {
    ...
    command: "npx azamat-ui-kit-cli add file-upload image-upload",
