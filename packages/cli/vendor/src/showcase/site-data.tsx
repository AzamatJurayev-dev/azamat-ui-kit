...
const componentSurfaceSections: Partial<Record<string, ComponentSurfaceSectionMeta[]>> = {
  ...
  select: [
    ...
    },
    {
      ...
      description: "These members cover static helper flows, remote loading, multi-select behavior, and keyboard-led local filtering.",
      slugs: ["simple-select", "async-select", "async-multi-select", "combobox"],
    },
    {
      key: "integrations",
      title: "Form integrations",
      description: "Use wrapped selects when you need consistent form-level validation, labels, and shell behavior.",
      slugs: ["form-select", "form-async-select"],
    },
  ],
  "date-picker": [
    {
...
export const moduleFamilyCatalog: ModuleFamilyItem[] = [
  ...
  },
  {
    ...
    icon: FormInputIcon,
    category: "Forms",
    exports: ["SimpleSelect", "AsyncSelect", "ClearableInput", "SearchInput", "PasswordInput", "NumberInput", "Slider", "RangeSlider", "Rating", "DateInput", "DateRangeInput", "MoneyInput", "QuantityInput", "MaskedInput", "PhoneInput", "TagInput", "Combobox"],
    href: moduleFamilyPath("inputs"),
    status: "Stable",
    features: ["Async select", "Slider controls", "Money input", "Date controls", "Tag input"],
  },
  {
    slug: "form",
    title: "Form adapters",
  ...
  },
  {
    ...
    icon: Table2Icon,
    category: "Data",
    exports: ["DataTable", "DataTablePagination", "DataTableColumnVisibilityMenu", "DataTableSelectColumn", "DataTableSortableHeader", "DataTableRowActions", "DataTableActionsColumn", "DataTableBulkActions", "DataTableViewPresets"],
    href: moduleFamilyPath("data-table"),
    status: "Stable",
    features: ["Bulk actions", "Sortable header", "View presets", "Row click", "Mobile fallback", "Pagination"],
  },
  {
    slug: "notifications",
    title: "Notifications",
...
export const featuredBlock: BlockCard = {
  ...
  installSteps: [
    "Run `npx azamat-ui-kit-cli init` and make sure the dashboard route already has theme tokens loaded.",
...
export const blockCards: BlockCard[] = [
  {
    ...
    relatedTemplateSlug: "dashboard-starter",
    installSteps: [
      "Run `npx azamat-ui-kit-cli init` and mount the shell inside an authenticated route group.",
  ...
  },
  {
    ...
    installSteps: [
      "Run `npx azamat-ui-kit-cli init` and reuse the CRM block inside an existing workspace route.",
  ...
  },
  {
    ...
    relatedTemplateSlug: "dashboard-starter",
    installSteps: [
      "Run `npx azamat-ui-kit-cli init` and move the table block into the target resource page.",
  ...
  },
  {
    ...
    relatedTemplateSlug: "dashboard-starter",
    installSteps: [
      "Run `npx azamat-ui-kit-cli init` and mount the auth block on a public or gated entry route.",
  ...
  },
  {
    ...
    relatedTemplateSlug: "dashboard-starter",
    installSteps: [
      "Run `npx azamat-ui-kit-cli init` and place the settings block inside an existing account or workspace page.",
  ...
  },
  {
    ...
    relatedTemplateSlug: "dashboard-starter",
    installSteps: [
      "Run `npx azamat-ui-kit-cli init` and copy the invoice block into the billing route.",
