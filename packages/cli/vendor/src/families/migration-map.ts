...
export const componentFamilyMigrationMap: FamilyMigrationEntry[] = [
  ...
  { component: "Slider", family: "InputFamily", member: "Slider", status: "family-member" },
  { component: "RangeSlider", family: "InputFamily", member: "RangeSlider", status: "family-member" },
  { component: "Rating", family: "InputFamily", member: "Rating", status: "family-member" },
