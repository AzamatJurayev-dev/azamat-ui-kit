...
function Calendar({
  ...
  return (
    <div
      data-slot="calendar"
      className={cn(
        "w-72 rounded-[calc(var(--radius-2xl)+2px)] border border-border/80 bg-popover/98 p-3 text-popover-foreground shadow-[0_24px_70px_rgba(15,23,42,0.16)] ring-1 ring-foreground/6 backdrop-blur",
        className
      )}
      {...props}
    >
