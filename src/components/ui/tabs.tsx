...
>(({ className, ...props }, ref) => (
    <BaseTabs.List
      ...
      data-slot="tabs-list"
      className={cn(
        "inline-flex min-h-11 items-center justify-center rounded-[var(--radius-2xl)] border border-border/85 bg-muted/88 p-1 text-muted-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur",
        className
      )}
    {...props}
  />
