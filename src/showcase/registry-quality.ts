...
export const registryQualityDemoRegistry = createShowcaseDemoRegistry([
  ...
  component("map", "MapView", "display", "Embeddable map view with controls, markers, selection state, and external navigation."),
  component("media-player", "MediaPlayer", "display", "Video playback surface with custom controls, tracks, volume, fullscreen, and progress state."),
  component("spreadsheet", "Spreadsheet", "data-table", "Editable spreadsheet grid for dense matrix entry with typed columns and cell selection."),
