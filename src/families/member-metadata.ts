...
export const componentMemberMetadata: ComponentMemberMetadata[] = [
  ...
  },
  {
    ...
    section: "presets",
    maturity: "member",
    summary: "Ready-made static-options member built around the shared select surface.",
    useWhen: "Use when teams want a fast static-options helper without reassembling the base Select props for common app settings and filter lists.",
  },
  {
  ...
  },
  {
    ...
    useWhen: "Use when users need to pick many remote items, keep selected tags visible, or create new items without leaving the same remote-search flow.",
  },
  {
    component: "Combobox",
    family: "SelectFamily",
